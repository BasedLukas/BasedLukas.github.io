...
!function() {
    ...
    const i = "session-id";
    let e, r, A, n, c = "analytics_events";
    let o = {};
    ...
    if (document.currentScript) {
        ...
        for (const a of document.currentScript.attributes) {
            if (a.name.startsWith("tb_")) {
                o[a.name.slice(3)] = a.value;
            }
        }
    }
    ...
    function s() {
        let a = `session-id=${t() || "10000000-1000-4000-8000-100000000000".replace(/[018]/g, a => (a ^ crypto.getRandomValues(new Uint8Array(1))[0] & 15 >> a / 4).toString(16))}; Max-Age=1800; path=/; Secure; SameSite=None`;
    ...
    function m() {
        ...
        setTimeout(() => {
            u("page_hit", {"user-agent": window.navigator.userAgent, locale: e, location: i, referrer: document.referrer, pathname: window.location.pathname, href: window.location.href});
        }, 300);
    }
    
    window.Tinybird = {trackEvent: u};
